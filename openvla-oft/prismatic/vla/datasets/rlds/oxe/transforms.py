...
def pick_up_red_cube_200_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    # Match DROID fine-tuning semantics for Franka: EEF Cartesian velocity + gripper.

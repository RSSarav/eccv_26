...
LANGUAGE_INSTRUCTION = "swap the green cube with red cube in the red bowl"
DATA_PATH = "/bluesclues-data/home/pingpong-nima/raj/eccv_26/0_data/swap_the_green_cube_with_red_cube_in_the_red_bowl_40_eccv"
IMAGE_RES = (720, 1280)
...
class SwapTheGreenCubeWithRedCubeInTheRedBowl(MultiThreadedDatasetBuilder):
    name = "swap_the_green_cube_with_red_cube_in_the_red_bowl"

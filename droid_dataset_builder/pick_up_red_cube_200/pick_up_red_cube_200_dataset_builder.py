...
LANGUAGE_INSTRUCTION = "pick up red cube"
DATA_PATH = "/bluesclues-data/home/pingpong-nima/raj/eccv_26/0_data/pick_up_red_cube_200_eccv_new"
IMAGE_RES = (720, 1280)
...
class PickUpRedCube200(MultiThreadedDatasetBuilder):
    name = "pick_up_red_cube_200"
            ...
            features=tfds.features.FeaturesDict(
                {
                    "steps": tfds.features.Dataset(
                        {
                            ...
                            "action": tfds.features.Tensor(
                                shape=(7,),
                                dtype=np.float64,
                                doc="Robot action, consists of [6D Cartesian velocity + gripper position].",
                            ),
                            ...
                            "is_terminal": tfds.features.Scalar(
                                dtype=np.bool_,
                                doc="True on terminal final step.",
                            ),
                    ...
                    "episode_metadata": tfds.features.FeaturesDict(
                        {
                            "file_path": tfds.features.Text(doc="Path to original data file."),
                            "recording_folderpath": tfds.features.Text(doc="Path to recordings folder."),
                        }
                    ),
                }
            )
    ...
    def _split_paths(self):
        ...
        episode_paths = [
            ...
            if os.path.exists(p + "/trajectory.h5") and os.path.exists(p + "/recordings/MP4")
        ]
